...
export default function GetSubscriptions(props) {
  ...
  const ccolumns = [
    { label: "customerId", id: "customerId", alignItems: "center", minWidth: 170 },
    { label: "CustomerName", id: "customername", alignItems: "center", minWidth: 170 },
    { label: "CompanyName", id: "companyname", alignItems: "center", minWidth: 170 },
    { label: "ContactEmail", id: "contactemail", alignItems: "center", minWidth: 170 },
    { label: "StartDate", id: "startdate", alignItems: "center", minWidth: 170 },
    { label: "EndDate", id: "enddate", alignItems: "center", minWidth: 170 }
  ]
  ...
  const TechnicalContactDetails = (datas) => {
    ...
    const setContactInputValue = (data1) => {
      if (data1.TechnicalContactDetails) {
        setCustomerId(data1.TechnicalContactDetails.customerId)
        setCustomerName(data1.TechnicalContactDetails.customerName)
        setCompanyName(data1.TechnicalContactDetails.companyName)
        setContactEmail(data1.TechnicalContactDetails.contactEmail)
        setStartDate(data1.TechnicalContactDetails.startDate)
        setEndDate(data1.TechnicalContactDetails.endDate)
      }
    }
        ...
        <Grid container style={{ paddingTop: "13px" }}>
          <Grid item xs={2} style={{ minWidth: "200px" }} >
            <Paper className={classes.tablePaper} style={{ background: '#f9f9fa' }}>
              <Box className="itemLabel" fontWeight="fontWeightBold" m={1}>Technical Contact Details</Box>
            </Paper>
          </Grid>
          {!actionButton ? <Grid item xs={3}>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell className={classes.detailsTableCell} style={!actionButton ? {} : { background: "white" }}>
                      ...
                      {
                        !actionButton ? <span>{data.TechnicalContactDetails ? data.TechnicalContactDetails.customerId : null}</span> :
                          <input style={inputStyle} className="form-control" type="text" placeholder="Customer Id" value={customerId} onChange={(event) => setCustomerId(event.target.value)} />
                      } 
                    </TableCell>

                    <TableCell className={classes.detailsTableCell} style={!actionButton ? {} : { background: "white" }}>
                      {
                        !actionButton ? <span>{data.TechnicalContactDetails ? data.TechnicalContactDetails.customerName : null}</span> :
                          <input style={inputStyle} className="form-control" type="text" placeholder="Customer Name" value={customerName} onChange={(event) => setCustomerName(event.target.value)} />
                      }
                    </TableCell>

                    <TableCell className={classes.detailsTableCell} style={!actionButton ? {} : { background: "white" }}>
                      {
                        !actionButton ? <span>{data.TechnicalContactDetails ? data.TechnicalContactDetails.companyName : null}</span> :
                          <input style={inputStyle} className="form-control" type="text" placeholder="Company Name" value={companyName} onChange={(event) => setCompanyName(event.target.value)} />
                      }
                    </TableCell>
                    <TableCell className={classes.detailsTableCell} style={!actionButton ? {} : { background: "white" }}>
                      {
                        !actionButton ? <span>{data.TechnicalContactDetails ? data.TechnicalContactDetails.contactEmail : null}</span> :
                          <input style={inputStyle} className="form-control" type="text" placeholder=" Contact Email" value={contactEmail} onChange={(event) => setContactEmail(event.target.value)} />
                      }
                    </TableCell>
