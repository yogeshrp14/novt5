  ...
  return (
    <div className={classes.root} style={{ padding: "20px 0px 7px" }}>
      ...
      <TabPanel value={value} index={0} dir={theme.direction} >
        {!loader ? (<GetSubscriptions data={rows} pageCount={count} isReseller={false} isAssociate={associate} isDirectCustomer={isDirectCustomer} handleId={handleId} linkId={linkId} />) : <Loader />}
      </TabPanel>
      <TabPanel value={value} index={1} dir={theme.direction} >
        {!loader ? (<GetSubscriptions data={rows} pageCount={count} isReseller={true} isAssociate={associate} isDirectCustomer={isDirectCustomer} handleId={handleId} linkId={linkId} />) : <Loader />}
      </TabPanel>
    </div>)
}
